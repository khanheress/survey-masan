...
export default function ImportParticipants({onClose,onSaved}){
 ...
 return <Modal isOpen onClose={()=>{if(!busy)onClose();}} title="Nhập data từ Excel" size="lg">
  <p className="form-hint">Trang đầu tiên có hàng tiêu đề: Tên, Số điện thoại, Nghề nghiệp, Người mời, Dự án tham gia, Năm sinh, Địa chỉ, Tình trạng hôn nhân. Bốn mục đầu bắt buộc; các mục còn lại có thể để trống hoặc không có cột. Người mời: Khánh hoặc Tế.</p>
