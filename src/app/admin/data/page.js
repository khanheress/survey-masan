        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          <div style={{ overflowX: 'auto' }}>
            <table className="data-table participant-table">
              <thead><tr><th>Tên</th><th>Số điện thoại</th><th style={{minWidth:90,whiteSpace:'nowrap'}}>Năm sinh</th><th>Nghề nghiệp</th><th>Người mời gần nhất</th><th>Dự án đã tham gia</th><th>Gần nhất</th><th>Thao tác</th></tr></thead>
              <tbody>{data.participants.map(person => (
                <tr key={person.id}>
                  ...
                  <td style={{minWidth:90,whiteSpace:'nowrap'}}>{person.respondent_birth_year || '—'}</td>
